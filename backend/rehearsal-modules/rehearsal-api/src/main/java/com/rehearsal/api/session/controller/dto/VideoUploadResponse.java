...
public record VideoUploadResponse(String sessionId, String videoUrl, VideoUploadStatus status) {

  public static VideoUploadResponse from(ClientSession session) {
    return new VideoUploadResponse(
        session.getSessionId(), session.getVideoUrl(), session.getVideoUploadStatus());
  }
}
