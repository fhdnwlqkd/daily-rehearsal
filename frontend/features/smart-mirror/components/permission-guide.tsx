    ...
    <div className="absolute inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-md">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <p className="leading-relaxed font-extralight text-white/60">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs leading-normal text-white/50">
                주소창 왼쪽 <span className="text-blue-400">자물쇠 아이콘</span>{" "}
                클릭 →<span className="text-blue-400"> 사이트 설정</span> →
                <span className="text-blue-400"> 카메라/마이크</span> '허용'으로
                변경
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-3">
          <Button
            onClick={onRetry}
            className="w-full rounded-full bg-white py-6 text-black hover:bg-white/90"
          >
            다시 시도하기
          </Button>
